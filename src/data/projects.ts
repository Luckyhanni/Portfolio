...
const baseProjects: Project[] = [
  ...
  },
  {
    ...
    status: "Demo verfügbar",
    hasDemo: true,
    short: "Digitales Voting-System für ESC-Abende mit Freunden, bei dem Songs bewertet und Ergebnisse live verfolgt werden können.",
    description: [
      "Das ESC Voting System entstand als private Web-App für gemeinsame ESC-Abende. Ziel war, den klassischen Bewertungszettel durch eine digitale Lösung zu ersetzen, die schnell verstanden wird und direkt am Abend funktioniert.",
      "Teilnehmer können über ihr eigenes Gerät abstimmen, während eine zentrale Anzeige den aktuellen Fortschritt, Teilnehmerstatus und spätere Ergebnisse sichtbar macht.",
      "Der Fokus liegt auf einfacher Bedienung, Gruppen-Erlebnis und schneller Nutzung ohne komplizierte Einrichtung.",
    ],
    tags: ["Web-App", "Voting", "Party Tool", "Live-Ergebnis", "Mobile First", "JavaScript", "Node.js"],
    techIcons: ["javascript", "nodejs"],
    highlights: [
      "Abstimmung direkt auf dem eigenen Gerät",
      "Gemeinsame Anzeige für Fortschritt und Rangliste",
      "Kompakter Party-Workflow statt aufwendiger Verwaltung",
    ],
    detailSections: [
      {
        title: "Voting per Handy",
        body: [
          "Jeder Teilnehmer kann auf dem eigenen Gerät Punkte für die Songs vergeben. Dadurch ersetzt die App klassische Bewertungszettel und macht den Abstimmungsprozess übersichtlicher.",
          "Die Oberfläche ist auf schnelle Eingaben ausgelegt: Name auswählen, Acts bewerten und das Voting speichern.",
        ],
        media: {
          src: "/projects/esc/esc-mobile-voting.svg",
          alt: "ESC Voting System Mockup der mobilen Voting-Ansicht",
          type: "image",
          width: 1600,
          height: 900,
          fit: "contain",
      ...
      {
        title: "Gemeinsame Ergebnisansicht",
        body: [
          "Die Ergebnisse können auf einem größeren Bildschirm angezeigt werden, sodass der ESC-Abend stärker wie eine eigene kleine Show wirkt.",
          "Fortschritt, Bewertungen und Ranking werden dadurch für alle sichtbar und müssen nicht manuell zusammengezählt werden.",
        ],
        media: {
          src: "/projects/esc/esc-results-board.svg",
          alt: "ESC Voting System Mockup einer gemeinsamen Ergebnisanzeige",
          type: "image",
          width: 1600,
          height: 900,
          fit: "contain",
      ...
      {
        title: "Party-Workflow statt komplizierter Verwaltung",
        body: [
          "Das System ist bewusst einfach gehalten: Teilnehmer eintragen, Songs bewerten, Ergebnisse anzeigen.",
          "Der Fokus liegt nicht auf einem großen Admin-System, sondern auf einer schnellen, spaßigen Nutzung im Freundeskreis.",
        ],
        media: {
          src: "/projects/esc/esc-admin-overview.svg",
          alt: "ESC Voting System Mockup einer einfachen Party-Workflow-Übersicht",
          type: "image",
          width: 1600,
          height: 900,
          fit: "contain",
