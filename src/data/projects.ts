...
const baseProjects: Project[] = [
  ...
  },
  {
    ...
    heroImage: "/projects/esc/esc-hero.svg",
    heroImageFit: "contain",
    logoImage: "/projects/esc/esc-logo.svg",
    demoUrl: "/demos/esc",
    status: "Demo verfügbar",
    hasDemo: true,
    short: "Lokale Party-Web-App für ESC-Abende mit Handy-Voting, Host-Admin, Beamer-Ansicht und Live-Auswertung.",
    description: [
      "Das ESC Voting System ist eine lokale Party-Web-App für gemeinsame ESC-Abende. Die App ersetzt Papier-Stimmzettel durch Handy-Voting und bündelt Host-Steuerung, Beamer-Ansicht und Auswertung in einem schlanken Node-Setup.",
      "Teilnehmer bewerten Acts auf dem eigenen Gerät mit Punkten von 1 bis 12 und können zusätzlich Favorite- und Cringe-Markierungen setzen. Der Host steuert parallel den aktuellen Act, die Beamer-Ansicht und die finale Freigabe der Ergebnisse.",
    ...
    highlights: [
      ...
      "Auswertungen mit Matrix, Stimmzetteln und Party-Statistiken",
    ],
    detailSections: [
      {
        title: "Voting auf dem Handy",
        body: [
          "Die Teilnehmer öffnen die Voting-Seite auf dem Handy, tragen ihren Namen ein und bewerten alle Acts mit Punkten von 1 bis 12.",
          "Der Fortschritt bleibt sichtbar, Zwischeneingaben werden lokal gehalten und Favorite- sowie Cringe-Markierungen machen die spätere Auswertung persönlicher als ein klassischer Papierzettel.",
        ],
        media: {
          src: "/projects/esc/esc-mobile-voting.svg",
          alt: "ESC Voting System Mockup einer mobilen Voting-Ansicht mit Punktefeld",
          type: "image",
          width: 720,
          height: 1280,
          fit: "contain",
      ...
      {
        title: "Host-Steuerung und Beamer-Modi",
        body: [
          "Der Admin-Bereich ist die Schaltzentrale für den Abend: aktueller Act automatisch oder manuell, Beamer-Ansicht wechseln und Ranking-Freigabe steuern.",
          "Für die Moderation gibt es eigene Modi für Lobby, TV-Modus, Ranking, Matrix, Stimmzettel und Statistiken. Zusätzlich kann der Host doppelte Teilnehmer zusammenführen oder den Abend bewusst zurücksetzen.",
        ],
        media: {
          src: "/projects/esc/esc-admin-overview.svg",
          alt: "ESC Voting System Mockup der Admin-Steuerung für Beamer und Teilnehmer",
          type: "image",
          width: 1600,
          height: 900,
          fit: "contain",
      ...
      {
        title: "Live-Auswertung für die Runde",
        body: [
          "Auf dem Beamer sieht die Gruppe den aktuellen Act, den nächsten Act, den Voting-Fortschritt und auf Wunsch ein Live-Ranking.",
          "Nach der Abstimmung helfen Ranking, Bewertungsmatrix, Stimmzettel, CSV-Export und Party-Statistiken dabei, den Abend wie eine kleine eigene Show abzuschließen.",
        ],
        media: {
          src: "/projects/esc/esc-results-board.svg",
          alt: "ESC Voting System Mockup einer Beamer-Auswertung mit Ranking und Party-Statistiken",
          type: "image",
          width: 1600,
          height: 900,
          fit: "contain",
